...
layout(location = 0) out vec3 vs_T0;
layout(location = 1) out vec3 vs_T1;
layout(location = 2) out vec3 vs_T2;
layout(location = 3) out float vs_T3;
layout(location = 4) out vec4 vs_Color;
